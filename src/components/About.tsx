...
const STATS = [
  ...
  { value: 2000, suffix: "+", label: "Bottles\nSold" },
...
const VALUES = [
  {
    word: "HERITAGE",
    desc: "Rooted in centuries of ancestral brewing tradition.",
  },
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col gap-4 flex-1">
          {VALUES.map((v) => (
            ...
            >
              ...
              <span
                className="font-inter text-white/55"
      ...
      <div className="about-quote px-6 md:px-[8%] pb-10 md:pb-12 shrink-0">
        ...
        >
          "A bridge between generations, nurturing friendship, culture, and
          celebration in every meaningful community gathering and ceremony."
        </p>
      </div>
    </section>
  );
