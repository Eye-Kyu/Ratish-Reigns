...
export default function Story() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.from(paras[0], { opacity: 0, y: 22, duration: 0.5, ease: 'power2.out' }, '-=0.2')
      tl.from(paras[1], { opacity: 0, y: 22, duration: 0.5, ease: 'power2.out' }, '+=0.3')
      tl.from(paras[2], { opacity: 0, y: 22, duration: 0.5, ease: 'power2.out' }, '+=0.3')
    }, section)
    ...
    >
      ...
      <div className="relative flex justify-center px-8 mb-16">
        ...
        <h2
          ...
          aria-hidden
          style={{ fontSize: 'clamp(36px, 9vw, 130px)', lineHeight: '1.0', letterSpacing: '0.06em' }}
        >
          {TITLE}
        </h2>
      ...
      <div
        ...
        style={{ fontSize: 'clamp(80px, 14vw, 200px)', lineHeight: '1', letterSpacing: '-0.02em' }}
        aria-hidden
      >
        2013
      </div>
